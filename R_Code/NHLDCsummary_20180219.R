...
png('/Users/jzwart/Documents/Jake/MyPapers/Regional Lake Carbon Model - ECI/Figures/Fig6_FracEvap_hrt.png',width = 7,
    height=7,units = 'in',res = 300)
par(mar=c(6,6,5,2))
cex.axis=2.5
cex.lab=2.5
...
dev.off()
summary(lm(all$percentEvap~all$HRT))
...
# mean kD by lake size 
summary(all$kD~all$lakeSizeBins)
